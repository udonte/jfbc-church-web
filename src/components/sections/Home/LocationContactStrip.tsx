        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-gray-700 font-medium mb-1">Our Location</p>
          ...
          >
            <div className="relative h-full rounded-2xl overflow-hidden shadow-lg border border-gray-200">
              {/* Map with Overlay */}
              <iframe
                src="https://www.google.com/maps/embed?pb=!4v1754463057728!6m8!1m7!1s6PeMpzm4pjotPqmdYYYeZg!2m2!1d6.590284865006226!2d3.302689286557383!3f351.5992891830186!4f11.843761958754541!5f1.9587109090973311"
                width="100%"
                height="100%"
...
export default LocationContactStrip;
